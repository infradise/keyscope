          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoGrid([
                  _InfoItem('Version', info['valkey_version'] ?? info['redis_version'] ?? 'N/A'),
                ...
                _buildInfoGrid([
                  ...
                  _InfoItem('Peak Memory', info['used_memory_peak_human'] ?? 'N/A'),
                  _InfoItem('Frag Ratio', info['mem_fragmentation_ratio'] ?? 'N/A'),
                ]),
                const SizedBox(height: 24),
                
                _buildSectionTitle('Stats'),
                _buildInfoGrid([
                  _InfoItem('Connected Clients', info['connected_clients'] ?? 'N/A'),
                  _InfoItem('Total Connections', info['total_connections_received'] ?? 'N/A'),
                  _InfoItem('Total Commands', info['total_commands_processed'] ?? 'N/A'),
                ]),
              ],
            ),
          );
