...
```yaml
# version: 0.3.1  # Previous version
...
Create a new release on GitHub. Use the tag you just created (e.g., `v0.4.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
